...
import Menu from './containers/homePage_new';
import LoginPage from './containers/login_new';
...
function App() {
  ...
  const [login, setLogin] = useState((loginBefore==='true')||false);
